...
double AgreementPhi::inflated::obs_loglik(
    ...
    double L0  = link::mu(ALPHA - K0);
    double L1  = link::mu(ALPHA - K1);
...
double AgreementPhi::inflated::E0_dalpha0dalpha1(
    ...
    double L0_0 = link::mu(ALPHA0 - K0_0);
    double L1_0 = link::mu(ALPHA0 - K1_0);
    double mu0  = link::mu(ALPHA0);
    double v0_0 = L0_0 * (1.0 - L0_0);
    double v1_0 = L1_0 * (1.0 - L1_0);
    double vmu0 = mu0 * (1.0 - mu0);
    double pc_0 = L0_0 - L1_0;

    double L0_1 = link::mu(ALPHA1 - K0_1);
    double L1_1 = link::mu(ALPHA1 - K1_1);
    double mu1  = link::mu(ALPHA1);
    double v0_1 = L0_1 * (1.0 - L0_1);
    double v1_1 = L1_1 * (1.0 - L1_1);
    double vmu1 = mu1 * (1.0 - mu1);
    double pc_1 = L0_1 - L1_1;
    ...
    if (pc_0 > 0.0 && pc_1 > 0.0) {
        double sc_0 = (v0_0 - v1_0) / pc_0;
        double sc_1 = (v0_1 - v1_1) / pc_1;
        double C  = PHI1 * vmu1;
        double C0 = PHI0 * vmu0;
