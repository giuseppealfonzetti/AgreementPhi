...
cpp_get_phi_oneway_profile <- function(Y, ITEM_INDS, ALPHA_START, PHI_START, K, J, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, PROF_METHOD, VERBOSE = FALSE, CONTINUOUS = FALSE) {
    .Call(`_AgreementPhi_cpp_get_phi_oneway_profile`, Y, ITEM_INDS, ALPHA_START, PHI_START, K, J, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, PROF_METHOD, VERBOSE, CONTINUOUS)
}

cpp_get_phi_oneway_modified_profile <- function(Y, ITEM_INDS, ALPHA_START, PHI_START, K, J, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, PROF_METHOD, VERBOSE = FALSE, CONTINUOUS = FALSE) {
    .Call(`_AgreementPhi_cpp_get_phi_oneway_modified_profile`, Y, ITEM_INDS, ALPHA_START, PHI_START, K, J, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, PROF_METHOD, VERBOSE, CONTINUOUS)
}

cpp_get_phi_twoway_profile <- function(Y, ITEM_INDS, WORKER_INDS, ALPHA_START, BETA_START, PHI_START, J, W, K, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, ALT_MAX_ITER, ALT_TOL, CONTINUOUS) {
    .Call(`_AgreementPhi_cpp_get_phi_twoway_profile`, Y, ITEM_INDS, WORKER_INDS, ALPHA_START, BETA_START, PHI_START, J, W, K, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, ALT_MAX_ITER, ALT_TOL, CONTINUOUS)
}

cpp_get_phi_twoway_modified_profile <- function(Y, ITEM_INDS, WORKER_INDS, ALPHA_START, BETA_START, PHI_START, J, W, K, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, ALT_MAX_ITER, ALT_TOL, CONTINUOUS, VERBOSE) {
    .Call(`_AgreementPhi_cpp_get_phi_twoway_modified_profile`, Y, ITEM_INDS, WORKER_INDS, ALPHA_START, BETA_START, PHI_START, J, W, K, SEARCH_RANGE, MAX_ITER, PROF_SEARCH_RANGE, PROF_MAX_ITER, ALT_MAX_ITER, ALT_TOL, CONTINUOUS, VERBOSE)
}
...
cpp_continuous_twoway_joint_loglik <- function(Y, ITEM_INDS, WORKER_INDS, LAMBDA, PHI, J, W, GRADFLAG = 0L) {
    .Call(`_AgreementPhi_cpp_continuous_twoway_joint_loglik`, Y, ITEM_INDS, WORKER_INDS, LAMBDA, PHI, J, W, GRADFLAG)
}

cpp_ordinal_twoway_joint_loglik <- function(Y, ITEM_INDS, WORKER_INDS, LAMBDA, PHI, J, W, K, GRADFLAG = 0L) {
