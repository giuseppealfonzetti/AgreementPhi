...
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental) [![CRAN status](https://www.r-pkg.org/badges/version/betaphi)](https://CRAN.R-project.org/package=betaphi)

<!-- badges: end -->

The package allows to accurately estimate general agreement measures for percentage and ordinal data even with low number of responses per item
...
aAnd also construct confidence intervals for the estimated agreement
